...
def build_random_function(min_depth, max_depth):
    """ Builds a random function of depth at least min_depth and depth
        ...
        returns: the randomly generated function represented as a nested list
                 ...
                 these functions)
    """
    options = ['prod','avg','cos_pi','sin_pi','x^2','x','y']
    functions = random.choice(options)
    if max_depth == 1:
        return random.choice(['x','y'])
    else:
        if functions == 'cos_pi' or functions == 'sin_pi' or functions == 'x^2':
            return [functions,build_random_function(min_depth-1,max_depth-1)]
        else:
            return [functions,build_random_function(min_depth-1,max_depth-1),build_random_function(min_depth-1,max_depth-1)]
#print build_random_function(1,2)
...
def generate_art(filename, x_size=350, y_size=350):
    ...
    #print evaluate_random_function(red_function, 60,60)
